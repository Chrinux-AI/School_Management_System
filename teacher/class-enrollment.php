...
<body class="cyber-bg">
                ...
                <?php if (empty($classes)): ?>
                    <div class="holo-card">
                        <div class="card-body" style="text-align:center;padding:50px;">
                            <i class="fas fa-chalkboard" style="font-size:4rem;color:rgba(0,191,255,0.3);margin-bottom:20px;"></i>
                            <div style="font-size:1.3rem;color:rgba(255,255,255,0.6);">You don't have any classes assigned yet.</div>
                        </div>
                    </div>
                <?php else: ?>
                    <!-- Class Selection -->
                    <div class="holo-card">
                        <div class="card-header">
                            <div class="card-title"><i class="fas fa-chalkboard-teacher"></i> <span>My Classes</span></div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <table style="width:100%;border-collapse:collapse;">
                                            <thead>
                                                <tr style="border-bottom:2px solid var(--cyber-cyan);">
                                                    ...
                                                    <th style="padding:12px;text-align:center;color:var(--cyber-cyan);font-weight:700;">EMAIL</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($enrolled_students as $student): ?>
                                                    <tr style="border-bottom:1px solid rgba(0,191,255,0.1);">
                                                        ...
                                                        <td style="padding:12px;text-align:center;color:rgba(255,255,255,0.7);font-size:0.85rem;"><?php echo htmlspecialchars($student['email']); ?></td>
    ...
    <?php if ($selected_class && !empty($available_students)): ?>
