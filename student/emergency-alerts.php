...
$alerts = db()->fetchAll("
    ...
    WHERE (ea.target_roles IS NULL OR ea.target_roles LIKE '%student%')
...
<body class="cyber-bg">
    ...
    <div class="alerts-container">
        ...
        <div class="safety-tip">
            <h3><i class="fas fa-shield-alt"></i> Safety Reminders</h3>
            <ul>
                <li><i class="fas fa-check"></i> Check this page regularly for important updates</li>
                <li><i class="fas fa-check"></i> Follow all emergency instructions immediately</li>
                <li><i class="fas fa-check"></i> Know your emergency exits and assembly points</li>
                <li><i class="fas fa-check"></i> Report any safety concerns to school staff</li>
            </ul>
        </div>
    </div>
