...
$alerts = db()->fetchAll("
    ...
    WHERE (ea.target_roles IS NULL OR ea.target_roles LIKE '%parent%')
...
<body class="cyber-bg">
    ...
    <div class="alerts-container">
        ...
        <p style="color: var(--text-secondary); margin-bottom: 2rem;">
            Stay informed about important school updates and emergency notifications
        </p>
                ...
                <div class="alert-card <?php echo $alert['severity']; ?>">
                    ...
                    <div class="alert-meta">
                        <span>
                            ...
                            By: <?php echo htmlspecialchars($alert['created_by_name'] ?? 'School Administration'); ?>
                        </span>
                        <span>
        ...
        <?php else: ?>
            <div class="no-alerts">
                ...
                <p>There are currently no emergency alerts. Your child's school is operating normally.</p>
            </div>
        <?php endif; ?>
        ...
        <div class="contact-info">
            ...
            <div class="contact-item">
                ...
                <span><strong>School Office:</strong> +1 (555) 123-4567</span>
            </div>
            <div class="contact-item">
                <i class="fas fa-shield-alt"></i>
                <span><strong>Security:</strong> +1 (555) 123-4568</span>
            </div>
            <div class="contact-item">
                <i class="fas fa-envelope"></i>
                <span><strong>Email:</strong> emergency@school.edu</span>
            </div>
            <div class="contact-item">
