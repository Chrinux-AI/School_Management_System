...
$users = db()->fetchAll("SELECT id, full_name, role, email FROM users WHERE role != 'admin' ORDER BY role, full_name");
if (!$users) $users = [];

// Get received messages
$received = db()->fetchAll("SELECT m.*, u.full_name as sender_name, u.role as sender_role
    FROM messages m
...
// Get sent messages
$sent = db()->fetchAll("SELECT m.*, u.full_name as receiver_name, u.role as receiver_role
    FROM messages m
        ...
        <main class="cyber-main">
            ...
            <div class="cyber-content slide-in">
                ...
                <div style="display:grid;grid-template-columns:1fr 2fr;gap:25px;margin-bottom:30px;">
                    <div class="holo-card">
                        <div class="card-header">
                            <div class="card-title"><i class="fas fa-paper-plane"></i> <span>New Message</span></div>
                        </div>
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div style="margin-bottom:15px;">
                                    ...
                                    <textarea name="message" required rows="6" style="width:100%;padding:10px;background:rgba(0,191,255,0.05);border:1px solid var(--cyber-cyan);border-radius:8px;color:var(--cyber-cyan);font-family:Roboto;"></textarea>
                                </div>
                    ...
                    <div class="holo-card">
                        <div class="card-header">
                            <div class="card-title"><i class="fas fa-users"></i> <span>All Users</span></div>
                        </div>
                ...
                <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:25px;">
                    <div class="holo-card">
                        <div class="card-header">
                            <div class="card-title"><i class="fas fa-inbox"></i> <span>Received Messages</span></div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="holo-card">
                        <div class="card-header">
                            <div class="card-title"><i class="fas fa-paper-plane"></i> <span>Sent Messages</span></div>
                        </div>
                        <div class="card-body">
                            <table class="holo-table">
                                <thead>
