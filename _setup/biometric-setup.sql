...
-- This creates tables for storing biometric authentication data
...
-- Create attendance_biometric table for biometric attendance marking
CREATE TABLE IF NOT EXISTS attendance_biometric (
    id INT AUTO_INCREMENT PRIMARY KEY,
    user_id INT NOT NULL,
    credential_id VARCHAR(255),
